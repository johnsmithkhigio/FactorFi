...
export default function StatusDocsClient() {
  const services = [
      ...
      <div>
        ...
        <div style={{ borderLeft: '2px solid var(--ff-border)', paddingLeft: 24, marginLeft: 8, display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 12.5, color: 'var(--ff-text-secondary)', lineHeight: 1.5 }}>
              Cross-chain bridging transactions from Ethereum Sepolia to Arc Testnet experienced validation delays due to high network gas fees on Sepolia. Resolving within 45 minutes.
            </p>
          </div>
        </div>
      </div>
